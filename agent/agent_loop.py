...
def _result(question_id, question, final_answer, trace, hit_cap, stop_reason) -> dict:
    return {
...
def run_question(question: str, question_id: str = "adhoc", max_tool_calls: int = MAX_TOOL_CALLS) -> dict:
    ...
    while True:
        ...
        if response.stop_reason != "tool_use":
            ...
            return _result(question_id, question, final_text, trace, False, response.stop_reason)
